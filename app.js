...
var incompleteTaskHolder=document.querySelector(".list_type_incompleted");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".list_type_completed");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    label.classList.add("item__span")
    ...
    editButton.classList.add("item__edit-save");
...
var editTask=function(){
    ...
    var label=listItem.querySelector(".item__span");
    var editBtn=listItem.querySelector(".item__edit-save");
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector(".item__edit-save");
